    ...
    <article className="w-dvw h-dvh bg-fixed bg-[url(./assets/bg.png)] overflow-y-auto overflow-x-hidden">
      {
        isLoading ?
          ...
          <>
            ...
            <section className='relative bg-(--color-palette-one) text-(--color-palette-four) flex gap-3 flex-col p-[3.5rem_2rem] bg-[url(./assets/bg.png)] bg-cover items-center'>
              <img src={ornament} alt="ornament" className='w-[6rem] h-[6rem] sm:w-[9rem] sm:h-[9rem] absolute top-3 left-3 rotate-[-90deg]' />
              <img src={ornament} alt="ornament" className='w-[6rem] h-[6rem] sm:w-[9rem] sm:h-[9rem] absolute top-3 right-3' />
              <img src={ornament} alt="ornament" className='w-[6rem] h-[6rem] sm:w-[9rem] sm:h-[9rem] absolute bottom-3 left-3 rotate-[180deg]' />
              <img src={ornament} alt="ornament" className='w-[6rem] h-[6rem] sm:w-[9rem] sm:h-[9rem] absolute bottom-3 right-3 rotate-[90deg]' />
              <p className='font-[GreatVibes] p-[.5rem_0] text-[2.7rem] bg-gradient-to-r from-(--color-palette-three) via-(--color-palette-four) to-(--color-palette-three) text-transparent bg-clip-text sm:text-7xl'>Nuestra Historia</p>
              <div className='flex-1 flex flex-col gap-8 items-center sm:mt-5 sm:flex-row max-w-[1280px] sm:justify-around mb-10'>
                ...
                <div className='font-[Lora] text-center text-(--color-palette-four) max-w-[500px]'>
