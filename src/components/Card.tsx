...
export const Card = ({ date, description, location, subtitle, title, src, link: { google, apple } }: PropsCard) => {
    ...
    return (
        <div ref={element} className='flex flex-col md:flex-row bg-(--color-palette-three)/5 border-t-2 border-b-2 border-(--color-palette-three)/30 text-(--color-palette-one) font-[Lora] p-4 text-sm lg:max-w-[900px] items-start opacity-0'>
