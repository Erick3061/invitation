...
export const Footer = () => {
    ...
    return (
        <section className='bg-(--color-palette-one) h-lvh w-lvw p-[1rem] flex flex-col justify-center items-center'>
            ...
            <a className='uppercase border w-[150px] p-4 mt-4 font-[Lora] rounded-full cursor-pointer text-center text-(--color-palette-four)/80' href='#iglesia'>Iglesia</a>
            <a className='uppercase border w-[150px] p-4 mt-4 font-[Lora] rounded-full cursor-pointer text-center text-(--color-palette-four)/80' href='#salon'>Salón</a>
