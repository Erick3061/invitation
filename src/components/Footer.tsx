    ...
    return (
        ...
        <section className=' bg-(--color-palette-one)'>
            <div ref={element} className='flex flex-col justify-end items-center sm:gap-6 opacity-0 p-[5rem_0]'>
                <p className='font-[Lora] p-1 text-2xl bg-gradient-to-r from-(--color-palette-four)/70 via-(--color-palette-four)/70 to-(--color-palette-four)/70 text-transparent bg-clip-text sm:text-3xl drop-shadow-heart2 text-center'>Nuestro amor es como el viento, no podemos verlo pero si sentirlo</p>
                <p className='font-[GreatVibes] p-[1rem] text-[2rem] bg-gradient-to-r from-(--color-palette-three) via-(--color-palette-four) to-(--color-palette-three) text-transparent bg-clip-text sm:text-5xl drop-shadow-heart2'>Erick & Yola</p>
