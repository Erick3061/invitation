...
export const Presentation = ({ refPresentation }: Proos) => {
    return (
        <section ref={refPresentation} className='relative h-lvh w-lvw bg-[url(./assets/1.webp)] bg-no-repeat bg-cover bg-[center_right_20%] xl:bg-[right_top_-350px] 2xl:bg-[right_top_-500px]'>
            ...
            <div className='w-full h-full flex justify-center backdrop-opacity-0'>
                <span>
                    <p className="uppercase font-[Lora] -tracking-[-.6rem] text-xl lg:text-3xl mt-[3rem] border-t border-b p-[.7rem_2.3rem] border-(--color-palette-four) text-(--color-palette-four) drop-shadow-heart">Nos casamos</p>
                </span>
